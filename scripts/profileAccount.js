...
function updateProfileUI(user) {
    ...
    document.getElementById('profileFullName').textContent = user.name || 'No especificado';
    ...
    document.getElementById('profileAddress').textContent = user.address || 'No especificada';
}
